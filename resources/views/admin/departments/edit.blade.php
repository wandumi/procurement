...
@section('browsertitle', 'Ecodashboard | Department ')
                ...
                <div class="col-md-8 mx-auto pt-5">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-lg-12 margin-tb">
                                                <div class="pull-left">
                                                <h2 class="fa fa-key" style="font-weight: bold; font-size:150%;"> {{ ucwords($departments->name) }} </h2>
                                                </div>
                                ...
                                <form action="{{ route('departments.update', $departments->id ) }}" method="POST">
                                    ...
                                    value="{{ $departments->name }}" id="name" name="name">
                                    @if($errors->has('name'))
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}"
                                               name="description" value="{{ $departments->description }}" id="display_name">
