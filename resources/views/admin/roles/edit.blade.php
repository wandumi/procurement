    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-10 margin-tb mb-3 mt-5">
                    <div class="pull-left">
                        <h2>Roles</h2>
                    </div>
                    ...
                    <div class="col-md-7">
                        <div class="card card-danger card-outline">
                            <div class="card-header ">
                                <h2 class="card-title" style="font-weight: bold; font-size:24px;">{{ ucfirst($roles->display_name) }}</h2>
                                <p class="pt-3">{{ $roles->description }}</p>    
                            </div><!-- /.card-header -->
                            <div class="card-body">
                                        ...
                                        <select class="select2 " multiple="roles"  data-placeholder="Select Roles" 
                                                ...
                                                @foreach($permissions as $permission )
                                                    <option value="{{ $permission->id }}"
                                                        @foreach($roles->permissions as $userRole)
                                                            @if($userRole->id == $permission->id)
                                                                selected
                                                            @endif
                                                        @endforeach>
                                                        {{ $permission->name }}
